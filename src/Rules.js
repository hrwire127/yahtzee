...
const ones = new TotalOneNumber({ value: 1 });
const twos = new TotalOneNumber({ value: 2 });
const threes = new TotalOneNumber({ value: 3 });
const fours = new TotalOneNumber({ value: 4 });
const fives = new TotalOneNumber({ value: 5 });
const sixes = new TotalOneNumber({ value: 6 });
